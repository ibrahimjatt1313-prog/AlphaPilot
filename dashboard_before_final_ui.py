...
TRADE_STATE_FILE = BASE_DIR / "agents" / "trade_state.json"
...
def normalize_stock_bars(raw_df):
...
def calculate_risk(option, account):
    ...
    if cost <= 0:
        ...
        reason = "Exceeds maximum account risk"
...
def position_avg_entry(position):
...
def position_market_price(position):
...
def position_market_value(position):
...
def position_unrealized_pl(position):
...
def position_unrealized_plpc(position):
...
def submit_paper_buy(option_symbol):
...
st.sidebar.markdown(
    """
<a class="sidebar-link" href="#account-overview">
    💰 Account Overview
</a>

<a class="sidebar-link" href="#market-status">
    🌐 Market Status
</a>

<a class="sidebar-link" href="#alpha-pilot-workflow">
    🧭 Workflow
</a>
""",
    unsafe_allow_html=True,
...
st.sidebar.markdown(
    '<div class="sidebar-section">AI TRADING</div>',
    unsafe_allow_html=True,
)

st.sidebar.markdown(
    """
<a class="sidebar-link" href="#agent-controls">
    ⚡ Agent Controls
</a>

<a class="sidebar-link" href="#agent-activity-terminal">
    🖥️ Agent Terminal
</a>

<a class="sidebar-link" href="#copilot-decision-center">
    🤖 Decision Center
</a>

<a class="sidebar-link" href="#technical-analysis">
    📊 Market Analysis
</a>

<a class="sidebar-link" href="#selected-option">
    🎯 Options Scanner
</a>

<a class="sidebar-link" href="#risk-assessment">
    🛡️ Risk Management
</a>

<a class="sidebar-link" href="#paper-entry-control">
    🚀 Paper Entry
</a>
""",
    unsafe_allow_html=True,
...
st.sidebar.markdown(
    """
<a class="sidebar-link" href="#active-option-contracts">
    📌 Active Positions
</a>

<a class="sidebar-link" href="#performance-risk">
    📈 Performance
</a>

<a class="sidebar-link" href="#recent-completed-trades">
    🧾 Trade History
</a>

<a class="sidebar-link" href="#recent-alpaca-orders">
    📋 Alpaca Orders
</a>
""",
    unsafe_allow_html=True,
...
st.sidebar.markdown(
    '<div class="sidebar-section">AUTONOMOUS SYSTEM</div>',
    unsafe_allow_html=True,
)

st.sidebar.markdown(
    """
<a class="sidebar-link" href="#autopilot-status">
    🤖 Autopilot
</a>

<a class="sidebar-link" href="#current-trade-state">
    🔄 Trade State
</a>

<a class="sidebar-link" href="#worker-information">
    ⚙️ Workers
</a>
""",
    unsafe_allow_html=True,
...
sidebar_market_status = (
    "OPEN"
    if market_open
    else "CLOSED"
)

sidebar_market_class = (
    "sidebar-connected"
    if market_open
    else "sidebar-warning"
)
...
<div class="sidebar-status">
    ...
    <div class="sidebar-status-text">
        ...
        Market:
        <strong class="{sidebar_market_class}">
            {sidebar_market_status}
        </strong>
...
st.markdown(
    '<div id="alpha-pilot-workflow"></div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    '<div id="agent-activity-terminal"></div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    '<div id="copilot-decision-center"></div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    '<div class="section-title">'
    '🎯 Options Scanner • Selected Contract'
    '</div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    '<div id="paper-entry-control"></div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    '<div id="active-option-contracts"></div>',
    unsafe_allow_html=True,
)
...
if open_option_positions:
    ...
    for position in open_option_positions:
        ...
        entry = position_avg_entry(position)

        current = position_market_price(position)

        market_value = position_market_value(
            position
        )

        unrealized = position_unrealized_pl(
            position
        )

        return_pct = position_unrealized_plpc(
            position
        )
        ...
        if state_symbol != position_symbol:
...
st.markdown(
    '<div id="recent-completed-trades"></div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    '<div id="recent-alpaca-orders"></div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    '<div id="current-trade-state"></div>',
    unsafe_allow_html=True,
)
